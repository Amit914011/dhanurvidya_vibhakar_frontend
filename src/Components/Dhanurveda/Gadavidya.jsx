...
import arrow2 from '../../assets/gadavidya hanuman ji.png'
...
import gadavidya1 from '../../assets/gadavidya image 1.jpg'
import gadavidya_3_days from '../../assets/3 day residentail camps.jpg'
import gadavidya_5_days from '../../assets/5 day residentail camps.jpg'
import gadavidya_7_days from '../../assets/7 day residentail camps.jpg'
...
<div class="flex flex-col-reverse lg:flex-row items-center md:items-start gap-4 p-[15px] md:px-[60px]">
  ...
  <div class="flex-shrink-0">
    <img 
      src={gadavidya1} 
      alt="Sample Image" 
      class="w-full lg:w-80 h-auto object-cover rounded-lg" 
    />
  </div>
</div>

<div class="flex flex-col lg:flex-row gap-6 px-[15px] md:px-[60px]">
...
<h1 className='mt-10 px-[15px] md:px-[60px] text-black text-center md:text-2xl font-bold'> Interested learn more? Register to enroll in Gadavidya today!</h1>

<div className="relative w-full h-48 sm:h-56 md:h-64 lg:h-48 mt-2">
  {/* Full-Width Image */}
  <img 
    src={dhanurbanner} 
    alt="Banner" 
...
<div className="benefits-container flex flex-col lg:flex-row gap-6 px-[15px] md:px-28">
  <div className="benefits-image flex-1 flex justify-center">
    {/* Replace the src with your own image URL */}
    <img src={arrow2} alt="Archer Illustration" className="max-w-full h-[300px]" />
  </div>
  <div className="benefits-list text-base md:text-md">
    <ul>
      <li className='flex justify-start items-start gap-3'>
        <img src={gadaicon} alt="" className='w-5 mt-2' />
        <div>
      ...
      <li className='flex justify-start items-start gap-3'>
      <img src={gadaicon} alt="" className='w-5 pt-2' />
       <div>
...
<div className="flex flex-wrap gap-6 justify-center px-3 mb-5 md:mb-0">
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-[#ffedd2] p-2 rounded-lg">
    ...
    <img 
      src={guru8} 
      alt="Image 1" 
      className="w-full object-cover h-[250px] rounded-lg mb-4"/>
    <button className="px-4 py-2  text-black rounded-md text-xl font-bold transition duration-300">
Learn More    </button>
  </div>
