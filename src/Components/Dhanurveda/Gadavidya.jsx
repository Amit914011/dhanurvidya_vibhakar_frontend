...
<div class="flex flex-col-reverse lg:flex-row items-center md:items-start gap-4 p-10">
 
  <div class="flex-grow ">
    <p class=" text-black md:text-md text-base ">
...
<div class="flex flex-col lg:flex-row gap-6 p-10">
...
<h1 className='mt-10 ml-6 text-black text-xl font-bold'> Interested learn more? Register to enroll in Gadavidya today!</h1>
...
<div className="flex flex-wrap md:flex-row gap-6 justify-center px-6">
