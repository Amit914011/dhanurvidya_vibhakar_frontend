...
import origin from '../../assets/GADAVIDYA TEXT.png'
...
<div class="flex flex-col-reverse lg:flex-row items-center md:items-start gap-4 p-10">
  ...
  <div class="flex-grow ">
    <p class="font-serif text-black md:text-xl text-base ">
...
<div class="flex flex-col gap-4 ">
  ...
  <div class="flex-1">
    <p class="text-black font-serif md:text-xl text-base  mt-10">
...
<div className="benefits-container flex flex-col lg:flex-row gap-6 px-6">
  ...
  <div className="benefits-list flex-1 text-base md:text-xl">
    <ul>
      <li>
...
Learn More    </button>
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-4 rounded-lg">
    <h2 className="md:text-xl text-base  font-bold mb-2 text-red-700">GADHA VIDYA CAMPS</h2>
    <img 
      src={guru9}
      alt="Image 2" 
      className="w-full h-auto object-cover rounded-lg mb-4"/>
