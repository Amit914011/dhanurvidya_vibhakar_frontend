...
<section className="bg-white w-full text-gray-900 p-3 lg:p-6 sm:p-12">
      {/* Content Container */}
      <div className="flex w-full flex-col-reverse lg:flex-row items-center gap-4">
        {/* Text Section */}
        ...
        {/* Image Section */}
        <div className="flex-1 w-[30%] flex justify-center">
          <img
            src={arrow}
            alt="Vedic art"
...
<div className="relative w-full h-64 sm:h-72 md:h-80 lg:h-96">
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-white px-6 py-4 rounded-md text-center max-w-[90%] md:max-w-[70%]">
      <p className="text-sm md:text-2xl  mt-2 capitalize">
...
<div className="md:flex flex flex-col md:flex-row gap-6 justify-center">
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <Link to="/khadagvidya" className="px-4 py-2  text-[#810000] hover:text-[#810000] rounded-md text-xl font-semibold transition duration-300">
Learn More    </Link>
  </div>
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <img 
      ...
      alt="Image 2" 
      className="w-full h-[250px] object-cover rounded-lg mb-4"/>
    <Link to='/gadavidya' className="px-4 py-2  text-[#810000] hover:text-[#810000] rounded-md text-xl font-semibold transition duration-300">
Learn More</Link>
  </div>
