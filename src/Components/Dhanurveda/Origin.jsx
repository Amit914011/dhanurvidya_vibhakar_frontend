...
<section className="bg-white w-full text-gray-900 p-3 lg:p-6 sm:p-12">
      {/* Content Container */}
      <div className="flex w-full flex-col-reverse md:flex-row items-start md:items-center lg:px-[60px] gap-4">
        {/* Text Section */}
        ...
        {/* Image Section */}
        <div className="flex-1 md:w-[25%] flex justify-center">
          <img
            src={arrow}
            alt="Vedic art"
    ...
    <section className="bg-white text-gray-900 p-3 md:p-6 sm:p-12">
        
      {/* Content Container */}
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6 lg:px-[60px]">
         {/* Image Section */}
...
<div className="relative w-full h-64 sm:h-72 md:h-80 lg:h-96">
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="text-white lg:px-6 py-4 rounded-md text-center max-w-[90%] md:max-w-[70%]">
      <h4 className="text-sm md:text-2xl   capitalize">
...
<div className="md:flex flex flex-col md:flex-row gap-6 justify-center px-[15px] lg:px-0">
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <Link to="/khadagvidya" className="px-4 py-2  text-black hover:text-black rounded-md text-xl font-semibold transition duration-300">
Learn More    </Link>
  </div>
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <img 
      ...
      alt="Image 2" 
      className="w-full h-[250px] object-cover rounded-lg mb-4"/>
    <Link to='/dhanur' className="px-4 py-2  text-black hover:text-black rounded-md text-xl font-semibold transition duration-300">
Learn More</Link>
  </div>
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <img 
      ...
      alt="Image 3" 
      className="w-full h-[220px] md:h-[190px] lg:h-[220px] object-cover rounded-lg mb-4"/>
    <Link to="/dhanur" className="px-4 py-2 text-black hover:text-black rounded-md text-xl font-semibold transition duration-300">
      Learn More
    </Link>
  </div>
...
<div className="md:flex flex flex-col md:flex-row gap-6 justify-center p-3">
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <img 
      src={guru8} 
      alt="Image 1" 
      className="w-full sm:h-[280px] md:h-[250px] object-cover rounded-lg mb-4"/>
    <Link to="/khadagvidya" className="px-4 py-2 text-black hover:text-black rounded-md text-xl font-bold transition duration-300">
Learn More    </Link>
  </div>
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <img 
      src={guru9}
      alt="Image 2" 
      className="w-full sm:h-auto md:h-[250px]  object-cover rounded-lg mb-4"/>
    <Link to='/gadavidya' className="px-4 py-2  text-black hover:text-black rounded-md text-xl font-bold transition duration-300">
Learn More    </Link>
  </div>
  ...
  <div className="w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex flex-col items-center bg-yellow-200 p-2 rounded-lg">
    ...
    <img 
      src={dhanurvidyaacharya}
      alt="Image 3" 
      className="w-full sm:h-[250px] md:h-[220px]  object-cover rounded-lg mb-4"/>
    <button className="px-4 py-2   text-black hover:text-black rounded-md text-xl font-bold transition duration-300">
      Read More
    </button>
  </div>
</div>
