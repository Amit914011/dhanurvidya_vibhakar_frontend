...
export default function Header() {
  ...
  return (
    <>
      <div>
        <header
          className={`h-20 text-[16px] fixed inset-x-0 flex-center bg-[#800000] z-[999] transition-all duration-300 ${
        ...
        >
          <nav className="flex-center-between w-full max-w-7xl mx-auto">
            <div className="flex-center gap-x-3 z-[999] relative">
             <Link to="/"> <img src={Logo} alt="Logo" className="w-24 ps-3" /></Link>
            </div>

            <ul className="gap-x-0 lg:flex-center hidden">  
            ...
            <div className="flex-center gap-x-5 px-5">
