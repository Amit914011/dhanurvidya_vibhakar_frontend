...
import pic from '../../assets/pic7.jpg';
...
function Guru() {
  return (
    ...
    >
      ...
      <motion.div
        className="relative flex flex-col lg:flex-row py-20 px-5 lg:px-20 bg-cover mt-1"
        style={{
      ...
      >
        ...
        {/* Title Animation */}
        <motion.h1
          className="text-4xl font-bold mb-6  text-center lg:text-left  text-[#a50f0f]"
          initial={{ x: -100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.6 }}
        >
         Guruji Vidya Prashasti Abhishekam Yajna.
        </motion.h1>
