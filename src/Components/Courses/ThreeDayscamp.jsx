...
import threedays from "../../assets/threedays.jpg"
import threedays1 from '../../assets/threedays1.png'
import threedays2 from '../../assets/threedays2.jpg'
import threedays3 from '../../assets/dhanurvidya3.png'
import threedays4 from '../../assets/khadagvidya.png'
import threedays5 from '../../assets/threedayskhadag.jpg'
import threedays6 from '../../assets/threedaygada.jpg'
...
<div className="flex flex-wrap justify-center gap-6 bg-yellow-200">
  ...
  <div className="flex flex-col items-center">
    <img src={threedays2} alt="Image 2" className="max-w-[300px] w-full h-auto" />
    <button className="mt-4 px-4 py-1 bg-orange-500 text-black font-bold rounded-3xl">
  15-17 | Dec | 2024 <br /> Learn more
</button>
  </div>
  <div className="flex flex-col items-center">
    <img src={threedays2} alt="Image 3" className="max-w-[300px] w-full h-auto" />
    <button className="mt-4 px-4 py-1 bg-orange-500 text-black font-bold rounded-3xl">
  15-17 | Dec | 2024 <br /> Learn more
</button>
  </div>
...
<div className="flex flex-wrap justify-center gap-6 bg-yellow-200">
  ...
  <div className="flex flex-col items-center">
    <img src={threedays5} alt="Image 2" className="max-w-[300px] w-full h-auto" />
    <button className="mt-4 px-4 py-1 bg-orange-500 text-black font-bold rounded-3xl">
  15-17 | Dec | 2024 <br /> Learn more
</button>
  </div>
  <div className="flex flex-col items-center">
    <img src={threedays5} alt="Image 3" className="max-w-[300px] w-full h-auto" />
    <button className="mt-4 px-4 py-1 bg-orange-500 text-black font-bold rounded-3xl">
  15-17 | Dec | 2024 <br /> Learn more
</button>
  </div>
...
<div className="flex flex-wrap justify-center gap-6 bg-yellow-200">
  ...
  <div className="flex flex-col items-center">
    <img src={threedays6} alt="Image 2" className="max-w-[300px] w-full h-auto" />
    <button className="mt-4 px-4 py-1 bg-orange-500 text-black font-bold rounded-3xl">
  15-17 | Dec | 2024 <br /> Learn more
</button>
  </div>
