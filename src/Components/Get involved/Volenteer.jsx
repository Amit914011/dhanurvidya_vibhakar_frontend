...
<div className="p-6 md:p-12 bg-white text-gray-800">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-4 text-lg">
            <li>
              ...
              <p className='text-black font-semibold'> Assisting in classes, cultural sessions, and skill development programs.</p>
            </li>
            <li>
              <span className="font-bold text-red-700">Dhanurveda Camps</span>
              <p className='text-black font-semibold'> Helping organize traditional martial arts and yoga training camps.</p>
            </li>
            <li>
              <span className="font-bold text-red-700">Community Outreach</span> 
              <p className='text-black font-semibold'>Befriending, mentoring, and serving in spiritual and cultural initiatives.</p>
            </li>
            <li>
              <span className="font-bold text-red-700">Event Participation and Organization</span>
              <p className='text-black font-semibold'> Preparing for festivals and events such as Parashurama Jayanti, Ayudha Puja, Yagnas, and other sacred occasions. </p>
            </li>
            <li>
              <span className="font-bold text-red-700">Food Service</span>
              <p className='text-black font-semibold'> Preparing and serving prasadam during festivals and functions.</p>
            </li>
            <li>
              <span className="font-bold text-red-700">Administrative and Fundraising Support</span>
              <p className='text-black font-semibold'> Assisting with logistics, records, and fundraising efforts for temple and gurukulam activities.</p>
            </li>
            <li>
              <span className="font-bold text-red-700">Media and Promotions</span>
              <p className='text-black font-semibold'> Capturing photos and videos of events, updating websites, and managing social media platforms (YouTube, Facebook, Instagram, etc.)</p>
            </li>
            <li>
              <span className="font-bold text-red-700">Preserving Dharma and Sacred Knowledge</span>
              <p className='text-black font-semibold'>Teaching initiatives that promote Sanatana Dharma, sacred texts, and traditional teachings.</p>
            </li>
          </ul>
        </div>
  ...
  <img
    ...
    <div className="p-6 md:p-10 bg-gray-50 rounded-lg shadow-md md:text-left text-center">
  <h1 className="text-3xl sm:text-4xl font-extrabold text-red-700 mb-6">
    Fulfill Your Dharma
  </h1>
...
<div className="flex flex-col md:flex-row items-center md:items-start gap-6 p-6 md:p-10 bg-gray-50 rounded-lg shadow-md">
  {/* Text Content */}
  <div className="md:w-1/2 md:text-left">
    <h1 className="text-2xl sm:text-2xl font-bold text-red-700 mb-4">Serving Lord Parashurama</h1>
...
<div className="p-6 md:p-10 bg-gray-50 rounded-lg shadow-md max-w-3xl mx-auto">
